...
return [
    ...
    "approved" => "bg-light-green-100 text-light-green-600 dark:bg-light-green-600 approved $default",
    "denied" => "bg-light-green-100 text-light-green-600 dark:bg-light-green-600 denied $default",

    "success-$color" => "bg-green-100 text-$color dark:bg-green-500 dark:text-$color $default",
    ...
    "approved-$color" => "bg-light-green-100 text-$color dark:bg-light-green-600 approved $default",
    "denied-$color" => "bg-light-green-100 text-$color dark:bg-light-green-600 denied $default",
